...
@override List<String>? get urls {
 ...
 final  Map<String, String?>? _urlThumbnails;
@override Map<String, String?>? get urlThumbnails {
  final value = _urlThumbnails;
  if (value == null) return null;
  if (_urlThumbnails is EqualUnmodifiableMapView) return _urlThumbnails;
  // ignore: implicit_dynamic_type

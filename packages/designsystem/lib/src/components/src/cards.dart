...
sealed class SingleChildCard extends SingleChildStatelessWidget {
  const SingleChildCard({super.key, super.child, this.onTap, this.onLongPress});
...
class ElevatedCard extends SingleChildCard {
  const ElevatedCard({super.key, super.child, super.onTap, super.onLongPress});
...
class FilledCard extends SingleChildCard {
  const FilledCard({super.key, super.child, super.onTap, super.onLongPress});
...
class OutlinedCard extends SingleChildCard {
  const OutlinedCard({super.key, super.child, super.onTap, super.onLongPress});

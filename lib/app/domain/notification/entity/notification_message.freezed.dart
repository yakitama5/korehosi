...
mixin _$NotificationMessage {
  ...
  int get hashCode => Object.hash(runtimeType, senderId, category,
      const DeepCollectionEquality().hash(data), from, messageId, messageType);
...
extension NotificationMessagePatterns on NotificationMessage {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _NotificationMessage() when $default != null:
        return $default(_that.senderId, _that.category, _that.data, _that.from,
            _that.messageId, _that.messageType);
      case _:
        return orElse();
    }
  }

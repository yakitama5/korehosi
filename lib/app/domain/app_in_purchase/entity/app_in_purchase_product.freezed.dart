...
mixin _$AppInPurchaseProduct {
  ...
  $AppInPurchaseProductCopyWith<AppInPurchaseProduct> get copyWith =>
      _$AppInPurchaseProductCopyWithImpl<AppInPurchaseProduct>(
          this as AppInPurchaseProduct, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is AppInPurchaseProduct &&
...
abstract mixin class $AppInPurchaseProductCopyWith<$Res> {
  factory $AppInPurchaseProductCopyWith(AppInPurchaseProduct value,
          $Res Function(AppInPurchaseProduct) _then) =
      _$AppInPurchaseProductCopyWithImpl;
  @useResult
...
extension AppInPurchaseProductPatterns on AppInPurchaseProduct {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AppInPurchaseProduct value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String title, double price)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AppInPurchaseProduct() when $default != null:
        return $default(_that.id, _that.title, _that.price);
      case _:
        return orElse();
    }
  }
...
class _AppInPurchaseProduct implements AppInPurchaseProduct {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AppInPurchaseProductCopyWith<_AppInPurchaseProduct> get copyWith =>
      __$AppInPurchaseProductCopyWithImpl<_AppInPurchaseProduct>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AppInPurchaseProduct &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.title, title) || other.title == title) &&
            (identical(other.price, price) || other.price == price));
  }
...
/// @nodoc
abstract mixin class _$AppInPurchaseProductCopyWith<$Res>
    implements $AppInPurchaseProductCopyWith<$Res> {
  factory _$AppInPurchaseProductCopyWith(_AppInPurchaseProduct value,
          $Res Function(_AppInPurchaseProduct) _then) =
      __$AppInPurchaseProductCopyWithImpl;
  @override
  @useResult
  $Res call({String id, String title, double price});
}

...
mixin _$SelectedImageModel {
  ...
  $SelectedImageModelCopyWith<SelectedImageModel> get copyWith =>
      _$SelectedImageModelCopyWithImpl<SelectedImageModel>(
          this as SelectedImageModel, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SelectedImageModel &&
...
abstract mixin class $SelectedImageModelCopyWith<$Res> {
  factory $SelectedImageModelCopyWith(
          SelectedImageModel value, $Res Function(SelectedImageModel) _then) =
      _$SelectedImageModelCopyWithImpl;
  @useResult
...
extension SelectedImageModelPatterns on SelectedImageModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_SelectedImageModel value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String? imagePath, XFile? uploadFile)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SelectedImageModel() when $default != null:
        return $default(_that.imagePath, _that.uploadFile);
      case _:
        return orElse();
    }
  }
...
class _SelectedImageModel implements SelectedImageModel {
  const _SelectedImageModel({this.imagePath, this.uploadFile})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$SelectedImageModelCopyWith<_SelectedImageModel> get copyWith =>
      __$SelectedImageModelCopyWithImpl<_SelectedImageModel>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _SelectedImageModel &&
            (identical(other.imagePath, imagePath) ||
                other.imagePath == imagePath) &&
            (identical(other.uploadFile, uploadFile) ||
                other.uploadFile == uploadFile));
...
/// @nodoc
abstract mixin class _$SelectedImageModelCopyWith<$Res>
    implements $SelectedImageModelCopyWith<$Res> {
  factory _$SelectedImageModelCopyWith(
          _SelectedImageModel value, $Res Function(_SelectedImageModel) _then) =
      __$SelectedImageModelCopyWithImpl;
  @override
  @useResult
  $Res call({String? imagePath, XFile? uploadFile});
}

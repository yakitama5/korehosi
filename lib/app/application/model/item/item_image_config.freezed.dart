...
mixin _$ItemImageConfig {
  ...
  $ItemImageConfigCopyWith<ItemImageConfig> get copyWith =>
      _$ItemImageConfigCopyWithImpl<ItemImageConfig>(
          this as ItemImageConfig, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ItemImageConfig &&
...
abstract mixin class $ItemImageConfigCopyWith<$Res> {
  factory $ItemImageConfigCopyWith(
          ItemImageConfig value, $Res Function(ItemImageConfig) _then) =
      _$ItemImageConfigCopyWithImpl;
  @useResult
...
extension ItemImageConfigPatterns on ItemImageConfig {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ItemImageConfig value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int minWidth, int minHeight, int quality)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _ItemImageConfig() when $default != null:
        return $default(_that.minWidth, _that.minHeight, _that.quality);
      case _:
        return orElse();
    }
  }
...
class _ItemImageConfig implements ItemImageConfig {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ItemImageConfigCopyWith<_ItemImageConfig> get copyWith =>
      __$ItemImageConfigCopyWithImpl<_ItemImageConfig>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ItemImageConfig &&
            (identical(other.minWidth, minWidth) ||
                other.minWidth == minWidth) &&
            (identical(other.minHeight, minHeight) ||
                other.minHeight == minHeight) &&
...
/// @nodoc
abstract mixin class _$ItemImageConfigCopyWith<$Res>
    implements $ItemImageConfigCopyWith<$Res> {
  factory _$ItemImageConfigCopyWith(
          _ItemImageConfig value, $Res Function(_ItemImageConfig) _then) =
      __$ItemImageConfigCopyWithImpl;
  @override
  @useResult
  $Res call({int minWidth, int minHeight, int quality});
}

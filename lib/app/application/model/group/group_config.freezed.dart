...
mixin _$GroupConfig {
  ...
  $GroupConfigCopyWith<GroupConfig> get copyWith =>
      _$GroupConfigCopyWithImpl<GroupConfig>(this as GroupConfig, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GroupConfig &&
...
abstract mixin class $GroupConfigCopyWith<$Res> {
  factory $GroupConfigCopyWith(
          GroupConfig value, $Res Function(GroupConfig) _then) =
      _$GroupConfigCopyWithImpl;
  @useResult
  $Res call({bool initialPremium, int initialItemCount, int validDays});
}

/// @nodoc
class _$GroupConfigCopyWithImpl<$Res> implements $GroupConfigCopyWith<$Res> {
...
extension GroupConfigPatterns on GroupConfig {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GroupConfig value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool initialPremium, int initialItemCount, int validDays)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _GroupConfig() when $default != null:
        return $default(
            _that.initialPremium, _that.initialItemCount, _that.validDays);
      case _:
        return orElse();
    }
  }
...
class _GroupConfig implements GroupConfig {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GroupConfigCopyWith<_GroupConfig> get copyWith =>
      __$GroupConfigCopyWithImpl<_GroupConfig>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GroupConfig &&
            (identical(other.initialPremium, initialPremium) ||
                other.initialPremium == initialPremium) &&
            (identical(other.initialItemCount, initialItemCount) ||
                other.initialItemCount == initialItemCount) &&
...
/// @nodoc
abstract mixin class _$GroupConfigCopyWith<$Res>
    implements $GroupConfigCopyWith<$Res> {
  factory _$GroupConfigCopyWith(
          _GroupConfig value, $Res Function(_GroupConfig) _then) =
      __$GroupConfigCopyWithImpl;
  @override
  @useResult
  $Res call({bool initialPremium, int initialItemCount, int validDays});
}
...
/// @nodoc
class __$GroupConfigCopyWithImpl<$Res> implements _$GroupConfigCopyWith<$Res> {

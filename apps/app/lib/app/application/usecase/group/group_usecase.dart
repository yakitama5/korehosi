...
class GroupUsecase with RunUsecaseMixin {
  ...
  Future<void> add({
    ...
    await execute(
      ...
      action: () async {
        ...
        // 登録
        await ref.read(groupRepositoryProvider).add(
              name: name,
              joinUids: [userId],
              ownerUid: userId,
  ...
  Future<void> update({
    ...
    await execute(
      ref,
      action: () => ref.read(groupRepositoryProvider).update(
            groupId: groupId,
            name: name,
          ),
    );
  ...
  Future<void> delete({required String groupId}) => execute(
        ref,
        action: () =>
            ref.read(groupRepositoryProvider).delete(groupId: groupId),
      );
